...
<head>
	...
	<title>SuperTasas | <?php the_title(); ?></title>
	<?php wp_head(); ?>
</head>
<body>
	...
	<div class="container">
		<nav class="d-flex pt-4 pb-4">
			<div class="d-flex align-items-center">
				...
				<a href="<?php echo get_home_url(); ?>/index.php" class="has-logo ml-md-auto ml-auto mr-auto">
					<img src="<?php echo get_template_directory_uri(); ?>/img/supertasas-logotipo.svg" alt="">
				</a>
			</div>
